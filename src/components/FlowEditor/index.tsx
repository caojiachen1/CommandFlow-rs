...
function InnerFlowEditor({ onPaneClick }: { onPaneClick?: () => void }) {
  ...
  const nodeTypes = useMemo(
    () => ({
      ...
      delay: ClickNode,
      powerShutdown: ClickNode,
      powerRestart: ClickNode,
      powerSleep: ClickNode,
      powerHibernate: ClickNode,
      powerLock: ClickNode,
      powerSignOut: ClickNode,
      systemVolumeMute: ClickNode,
      systemVolumeSet: ClickNode,
      systemVolumeAdjust: ClickNode,
      systemBrightnessSet: ClickNode,
      systemWifiSwitch: ClickNode,
      systemBluetoothSwitch: ClickNode,
      systemNetworkAdapterSwitch: ClickNode,
      systemTheme: ClickNode,
      systemPowerPlan: ClickNode,
      systemOpenSettings: ClickNode,
      guiAgent: ClickNode,

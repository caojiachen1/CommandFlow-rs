...
export default function StartMenuAppSelect({ apps, value, placeholder, onSelect, onEnter, hint }: StartMenuAppSelectProps) {
  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      {open ? (
        <div
          className="cf-card cf-prop-dropdown-menu absolute z-[260] mt-1.5 w-full rounded-xl border border-slate-200 bg-white/95 p-1 backdrop-blur-md dark:border-neutral-700 dark:bg-neutral-900/95"
        >

...
const categories: NodeCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '系统关机', kind: 'powerShutdown', color: 'bg-red-500' },
      { label: '系统重启', kind: 'powerRestart', color: 'bg-red-600' },
      { label: '系统睡眠', kind: 'powerSleep', color: 'bg-slate-500' },
      { label: '系统休眠', kind: 'powerHibernate', color: 'bg-slate-600' },
      { label: '锁定系统', kind: 'powerLock', color: 'bg-zinc-500' },
      { label: '注销登录', kind: 'powerSignOut', color: 'bg-zinc-600' },

...
export default function VariablePanel() {
  ...
  return (
    <section className="cf-window cf-pane flex h-full flex-col overflow-hidden">
      ...
      {variableEntries.length === 0 ? (
        <div className="flex flex-1 items-center justify-center overflow-hidden text-[11px] text-slate-400">
          <div className="cf-empty flex flex-col items-center rounded-xl border border-dashed border-slate-300 px-6 py-8 text-center dark:border-neutral-800">
        ...
        <div className="min-h-0 flex-1 overflow-auto p-2">
          <ul className="space-y-1.5">
            {variableEntries.map(([key, value]) => (
              <li key={key} className="cf-card rounded-lg border border-slate-200 bg-white/70 px-2.5 py-2 text-[11px] dark:border-neutral-800 dark:bg-neutral-900/60">

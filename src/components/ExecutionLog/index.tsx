...
export default function ExecutionLog() {
  ...
  return (
    <section className="flex h-[280px] flex-col border-b border-slate-200 p-4 dark:border-neutral-800">
      ...
      <div className="flex-1 overflow-y-auto rounded-lg border border-slate-200 bg-white p-2 text-[11px] shadow-inner scrollbar-thin scrollbar-thumb-slate-200 dark:border-neutral-800 dark:bg-neutral-900 dark:scrollbar-thumb-slate-800">
        {logs.length === 0 && (

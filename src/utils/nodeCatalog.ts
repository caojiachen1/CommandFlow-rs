...
const categories: NodePaletteCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '复制文件/文件夹', kind: 'fileCopy', color: 'bg-fuchsia-500', category: '系统与文件' },
      { label: '移动文件/文件夹', kind: 'fileMove', color: 'bg-pink-500', category: '系统与文件' },
      { label: '删除文件/文件夹', kind: 'fileDelete', color: 'bg-rose-500', category: '系统与文件' },
      ...
      { label: '读取文本文件', kind: 'fileReadText', color: 'bg-fuchsia-600', category: '系统与文件' },
      { label: '写入文本文件', kind: 'fileWriteText', color: 'bg-pink-600', category: '系统与文件' },
